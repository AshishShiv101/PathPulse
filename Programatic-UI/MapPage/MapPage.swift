...
class MapPage: UIViewController, CLLocationManagerDelegate, UISearchBarDelegate, MKMapViewDelegate, MKLocalSearchCompleterDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    func completerDidUpdateResults(_ completer: MKLocalSearchCompleter) {
        ...
        print("Updated results: \(searchResults.count)") // Debug
...
//        print("Tapped: \(selectedSuggestion.title)") // Debug
...
//    }
    ...
    // Add this in setupSuggestionTableView() after setting up the table view
    ...
    @objc private func handleSuggestionBoxTap(_ gesture: UITapGestureRecognizer) {
        ...
        // If the tap was on a row, didSelectRowAt will handle it instead
    }

    // Existing method (kept as is) for specific row selection
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let selectedSuggestion = searchResults[indexPath.row]
        searchBar.text = selectedSuggestion.title
        suggestionTableView.isHidden = true
