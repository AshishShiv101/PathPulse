...
class GuidePage: UIViewController, UISearchBarDelegate, UICollectionViewDelegate, UICollectionViewDataSource, CLLocationManagerDelegate {
    ...
    private func setupCityHeader() {
        ...
        NSLayoutConstraint.activate([
            ...
            cityLabel.trailingAnchor.constraint(lessThanOrEqualTo: filterButton.leadingAnchor, constant: -10),
...
private func setupScrollView() {
    ...
    private func setupCarousels() {
        ...
        let itemWidth: CGFloat = isPad ? 300 : 200
        let itemHeight: CGFloat = isPad ? 350 : 270
        // Adjust the collection view height to accommodate the item height plus padding
        let collectionViewHeight: CGFloat = itemHeight + 20
        
        var previousCarousel: UIView? = nil
        carouselCollectionViews.removeAll()
        let carouselTitles = ["Clinics", "Hospitals", "Hotels", "Pharmacies", "Gas Stations"]
        ...
        for (index, title) in carouselTitles.enumerated() {
            ...
            // Use the defined item sizes instead of hardcoded values
            ...
            NSLayoutConstraint.activate([
                ...
                // Use dynamic height instead of hardcoded 260
...
func locationManager(_ manager: CLLocationManager, didFailWithError error: Error) {
    ...
    private func fetchNearbyPlaces() {
        ...
        let categories = ["clinic", "hospital", "hotel", "pharmacy", "gas_station"]
        let titles = ["Clinics", "Hospitals", "Hotels", "Pharmacies", "Gas Stations"]
    ...
    @objc private func showFilterOptions() {
        let alert = UIAlertController(title: "Filter Options",
                                     message: "Sort by:",
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        let title = ["Clinics", "Hospitals", "Hotels", "Pharmacies", "Gas Stations"][collectionView.tag]
