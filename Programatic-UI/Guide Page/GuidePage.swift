...
class GuidePage: UIViewController, UISearchBarDelegate, UICollectionViewDelegate, UICollectionViewDataSource, CLLocationManagerDelegate {
    ...
    @objc private func showFilterOptions() {
        ...
        // New option: Best Rating + Nearest Distance
        ...
        alert.addAction(sortByRatingAndDistanceAction) // Add the new action
    ...
    private func filterByRatingAndDistance() {
        ...
        carouselData = carouselData.mapValues { items in
            items.sorted { item1, item2 in
                // Calculate distance for both items
                ...
                let normalizedDistance1 = min(distance1 / maxDistance, 1.0) // Cap at 1.0
                ...
                return score1 > score2 // Sort in descending order of score
            }
        }
        reloadAllCarousels()
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        // Pass the current user location to the cell
